...
class CcodeAdmin(BotsAdmin):
    ...
    fieldsets = (
        (None, {'fields': ('ccodeid','leftcode','rightcode','attr1','attr2','attr3','attr4','attr5','attr6','attr7','attr8'),
                'description': 'For description of user code lists and usage in mapping: see <a target="_blank" href="https://bots.readthedocs.io/en/latest/configuration/mapping-scripts/code-conversion/">wiki</a>.',
...
class ChannelAdmin(BotsAdmin):
    ...
    fieldsets = (
        ...
        (_('Safe writing & file locking'),{'fields': ('mdnchannel','syslock', 'lockname'),
                         'description': 'For more info see <a target="_blank" href="https://bots.readthedocs.io/en/latest/configuration/channel/file-locking/">wiki</a><br>',
                         'classes': ('collapse wide extrapretty',)
                        }),
